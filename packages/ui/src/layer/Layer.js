...
class Layer extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    const { target, align, classes, offset } = this.props
  ...
  onSetRef = (element) => {
    ...
    if (element) {
      this.target = targetSelection === 'previousSibling'
